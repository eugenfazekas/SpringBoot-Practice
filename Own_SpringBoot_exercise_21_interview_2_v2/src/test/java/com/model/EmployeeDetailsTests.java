...
public class EmployeeDetailsTests {
	...
	public EmployeeDetails getEmployeeDetails() {
		...
		employeeDetails.setDepartments(arr);
	...
	void getterSetterTest() {
		...
		assertAll(		
	    		 () -> assertEquals(arr,EmployeeDetails.getDepartments())
	    		 );		
	}
	...
	void toStringTest() {
		...
		assertEquals("Employee [firstName=" + "John"+ ", lastName=" + "Markovics" + ", department="
				+ Arrays.toString(getEmployeeDetails().getDepartments()) + "]",getEmployeeDetails().toString());
	}
}
