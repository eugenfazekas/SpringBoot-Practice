...
public class BindEmployeeService {
	...
	*/	
	EmployeeDetails bindEmployee(String input) {	
		...
		employeeDetails.setFirstName(split_firstName_lastName[0]);
		employeeDetails.setLastName(split_firstName_lastName[1]);
		employeeDetails.setDepartments(splitElements(employeeSplit[1], "<department>|<\\/department>"));
